...
//============================================================================================================
if (!function_exists('bisnis_url')){
	function bisnis_url($bisnis){
		$url = site_url('bisnis/detail/'.$bisnis['url']);

		return $url;
	}
}

if (!function_exists('siaranpers_url')){
	function siaranpers_url($siaranpers){
		$url = site_url('siaranpers/detail/'.$siaranpers['url']);
...
if (!function_exists('berita_url')){
	function berita_url($berita){
		$url = site_url('hubunganinvestorberita/detail/'.$berita['url']);
