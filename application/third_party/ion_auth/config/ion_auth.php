 ...
 */
$config['site_title']                 = "Pegadaian";       // Site Title, example.com
$config['admin_email']                = "admin@pegadaian.co.id"; // Admin Email, admin@example.com
...
$config['user_expire']                = 86500*7;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['forgot_password_expiration'] = 86500;                   // The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
