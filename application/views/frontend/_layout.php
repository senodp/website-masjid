            ...
            <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-4 text-white animated zoomIn"><?=$Page['title']?></h1>
                        <a href="<?=site_url()?>" class="h5 text-white">Home</a>
                        <i class="fas fa-arrow-circle-right text-white px-2"></i>
                        <a href="" class="h5 text-white"><?=$Page['title']?></a>
                        <?php if($this->uri->segment(2) == 'read'){ ?>
                            <i class="fas fa-arrow-circle-right text-white px-2"></i>
                            <a href="" class="h5 text-white">Detail</a>
                        <?php }elseif($this->uri->segment(2) == 'category'){ ?>
                            <i class="fas fa-arrow-circle-right text-white px-2"></i>
                            <a href="" class="h5 text-white">Kategori <?=$taxonomy['name']?></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
