  ...
  <div class="scroll-wrap">
    <div class="scrollable-content">
      ...
      <div class="vertical-centred list-content list-team">
              ...
              <div class="col-12">
                <div class="title-section-home title-section-team w-100 d-flex justify-content-center">
                  <h3 class="animated color-font fadeInUp" data-ckav-sm="fs30" data-animin="fadeInUp|0.1"
                    style="animation-delay: 0.1s;"><?=option_value('overviewpageteam_title')?></h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="boxed">
            <div class="wrp-summary-team mt-lg-5 mt-md-5 mt-sm-0 mt-0 pt-1">
              <div class="col-12 pt-5 mt-2"></div>
              <?=option_value('overviewpageteam_summary')?>
            </div>
            <div class="wrp-list-team mb-lg-5 mb-md-5 mb-sm-3">
              <div class="row gutter--24 flex-direction-column">
                <?php foreach ($ourteam as $row): ?>
                  <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="wrp-card-teams">
                      <div class="link-people-team">
                        <div class="desc-people">
                          <div class="wrp-desc-scrl">
                            <p><?=$row['content'];?></p>
                          </div>
                          <div class="peoplename-title">
                            <h2><?=$row['title'];?></h2>
                            <p><?=$row['position'];?></p>
                            <div class="bottom-captional">
                              <div class="icon-captional">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                  xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 58.6 72" style="enable-background:new 0 0 58.6 72;" xml:space="preserve">
                                  <path d="M0.5,1.7v55.2c0,0.7,0.5,1.2,1.2,1.2h41.2v13.5l15-13.5v-1.9V1.9c0-0.7-0.5-1.2-1.2-1.2H1.5C1,0.7,0.5,1.2,0.5,1.7z" />
                                </svg>
                              </div>
                              <div class="captional-people-bottom">
                                <p><?=$row['ups'];?></p>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="wrp-team-image">
                          <img src="<?=img_url($row['image'], 'team')?>" alt="">
                        </div>
                        <div class="peoplename-title">
                          <h2><?=$row['title'];?></h2>
                          <p><?=$row['position'];?></p>
                ...
                <!-- <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="wrp-card-teams">
                    <div class="link-people-team">
                      <div class="desc-people">
                        <div class="wrp-desc-scrl">
                          <p>Denny has around 20 years of experience in CRM, Contact Centre Management, eCommerce,
                            and fulfillment Management. Her multi-functional experience enables her to design and
                            deliver an integrated Customer Experience.</p>
                        </div>
                        <div class="peoplename-title">
                          <h2>Denny C Siregar</h2>
                          <p>Managing Director</p>
                          <div class="bottom-captional">
                            <div class="icon-captional">
                              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 58.6 72"
                                style="enable-background:new 0 0 58.6 72;" xml:space="preserve">
                                <path
                                  d="M0.5,1.7v55.2c0,0.7,0.5,1.2,1.2,1.2h41.2v13.5l15-13.5v-1.9V1.9c0-0.7-0.5-1.2-1.2-1.2H1.5C1,0.7,0.5,1.2,0.5,1.7z" />
                              </svg>
                            </div>
                            <div class="captional-people-bottom">
                              <p>You might encounter him on the hills of Sentul, screaming ‘BIKE FOR LIFE!!”</p>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="wrp-card-teams">
                    <div class="link-people-team">
                      <div class="desc-people">
                        <div class="wrp-desc-scrl">
                          <p>Yoga has around 20 years of experience in CRM, Contact Centre Management, eCommerce,
                            and fulfillment Management. Her multi-functional experience enables her to design and
                            deliver an integrated Customer Experience.</p>
                        </div>
                        <div class="peoplename-title">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="wrp-card-teams">
                    <div class="link-people-team">
                      <div class="desc-people">
                        <div class="wrp-desc-scrl">
                          <p>Franky has around 20 years of experience in CRM, Contact Centre Management,
                            eCommerce,
                            and fulfillment Management. Her multi-functional experience enables her to design and
                            deliver an integrated Customer Experience.</p>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="wrp-card-teams">
                    <div class="link-people-team">
                      <div class="desc-people">
                        <div class="wrp-desc-scrl">
                          <p>Dayna has around 20 years of experience in CRM, Contact Centre Management,
                            eCommerce,
                            and fulfillment Management. Her multi-functional experience enables her to design and
                            deliver an integrated Customer Experience.</p>
                        </div>
                        <div class="peoplename-title">
                          <h2>Dayna Humphreys</h2>
                          <p>Digital marketing specialist</p>
                          <div class="bottom-captional">
                            <div class="icon-captional">
                              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="wrp-card-teams">
                    <div class="link-people-team">
                      <div class="desc-people">
                        <div class="wrp-desc-scrl">
                          <p>Sean has around 20 years of experience in CRM, Contact Centre Management,
                            eCommerce,
                            and fulfillment Management. Her multi-functional experience enables her to design and
                            deliver an integrated Customer Experience.</p>
                        </div>
                        <div class="peoplename-title">
                          <h2>Sean Carey Yamazaki</h2>
                          <p>Digital marketing specialist</p>
                          <div class="bottom-captional">
                            <div class="icon-captional">
                              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            ...
            <!-- <div class="wrp-link-bottom">
              <div class="row gutter--24 row-guuter-group align-items-center">
                <div class="col-xl-8 col-lg-8 col-sm-7 col-12">
                  <div class="wrp-link-group-line">
                    <h4>How did we get here?</h4>
                  </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-sm-5 col-12 act-link-page-buttom">
                  <a class="btn btn-square" href="#">Read about our history</a>
                </div>
              </div>
              <div class="row gutter--24 row-guuter-group align-items-center">
                <div class="col-xl-8 col-lg-8 col-sm-7 col-12">
                  <div class="wrp-link-group-line">
                    <h4>See how we can help you</h4>
                  </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-sm-5 col-12 act-link-page-buttom">
                  <a class="btn btn-square" href="#">Contact Us</a>
                </div>
              </div>
            </div> -->
          </div>
        ...
        <div class="container-fullpage">
          <div class="boxed">
            <div class="row mt-4 mb-4 md-justify-content-center">
