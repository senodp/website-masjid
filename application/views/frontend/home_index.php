...
<div class="pagepiling">
  <div data-anchor="page1" class="pp-scrollable text-white section section-1">
    <div class="scroll-wrap scroll-bakground-after">
      ...
      <div class="section-bg lazyload" style="background-image:url(<?=img_url(str_replace(".png",".jpg",$slide['image']), 'slides')?>);"></div>
      ...
      <div class="scrollable-content">
        <div class="vertical-centred">
          <div class="about-home p-realtive w-100">
            <div class="bg-holder-about lazyload" style="background-image: url('<?=option_thumb_url('about_image', assets_url('frontend/img/cover1.jpg'))?>')"></div>
  ...
  <div data-anchor="page3" class="pp-scrollable text-white section section-3 index-3">
    <div class="scroll-wrap">
      <div class="section-bg lazyload" style="background-image: url('<?=option_thumb_url('backgroundservices_image', assets_url('frontend/img/cover1.jpg'))?>')"></div>
      <div class="scrollable-content">
                      ...
                      <div class="icn-text-services">
                        <div class="icon">
                          <div class="wrp-icon-services">
                            <img class="lazyload" src="<?=img_url($serv['image'], 'services')?>" alt="icon one">
                          </div>
                        </div>
                        ...
                        <div class="card-header" id="headingOne1">
                          <div class="icon-accordion-title" type="button" data-toggle="collapse"
                            ...
                            <div class="icon-accordion">
                              <img class="lazyload" src="<?=img_url($r['image'], 'services')?>" alt="icon one">
                            </div>
                            ...
                            <div class="row align-items-center">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12 col-card-showcase">
                                  ...
                                  <a class="link-card-showcase" href="<?=listshowcase_url($ls, $Page_url)?>">
                                    ...
                                    <img class="img-fluid lazyload" src="<?=img_url($ls['cover'], 'listpages')?>" alt="Case study one">
                                  </a>
                                </div>
                              </div>
                              <?php endforeach; ?>
  ...
  <div data-anchor="page5" class="pp-scrollable bg-white text-white section section-5">
    <div class="scroll-wrap">
                  ...
                  <div class="row-specialization">
                        ...
                        <div class="row d-none d-sm-none d-md-none d-lg-flex d-xl-flex">
                          ...
                          <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div
                              ...
                              <div class="img -mr-t-60 shadow-small rd" data-ckav-sm="mr-l-0"><img src="<?=img_url($testi['image'], 'testimonial')?>" class="rd lazyload" alt="image"></div>
                              ...
                              <div class="col-12 col-sm-12 col-md-12 card-testimony">
                                <div
                                  ...
                                  <div class="img -mr-t-60 shadow-small rd" data-ckav-sm="mr-l-0"><img
                                      src="<?=img_url($testi['image'], 'testimonial')?>" class="rd lazyload" alt="image"></div>
                                  <div class="info-costumer">
                                    <h3 class=""><?=$testi['title']?></h3>
                                    <em class="fs12 f-2"><?=$testi['position']?></em>
                                    <h2 class="title bold-n small mr-auto txt-default with-sep-r mr-b-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12 col-12">
                        ...
                        <div class="clients-home slider">
                          <?php foreach ($logo as $clients): ?>
                          <div class="wrp-clients-home">
                            <img alt="" src="<?=img_url($clients['image'], 'logo')?>">
                          </div>
                          <?php endforeach; ?> 
                        </div>
            ...
            <div class="vertical-centred">
              <div class="boxed boxed-inner">
                <div class="boxed">
                  <div class="container">
                    <div class="intro">
                      <h2 class="title text-white">Our partners on making <span class="text-primary">sustainable</span>
                        Indonesia</h2>
      ...
      <div data-anchor="page6" class="pp-scrollable section section-6">
        <div class="scroll-wrap">
          <div class="section-bg bg-white lazyload" style="background-image: url('<?=assets_url('frontend')?>/images/bg-sq.webp');"></div>
          <div class="scrollable-content">
                                          ...
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="row justify-content-center">
                                              <a class="link-action" href="callto:<?=option_value('contact_phone')?>">
                                                ...
                                                <div class="icon-call-mail">
                                                  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                    viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;"
                                                    xml:space="preserve">
                                                    <path d="M25.7,11.1c0,0-2.5-9-8.7-10c0,0-4.7-1.1-9.7,3.8c0,0-4.3,5.7-1.4,14.5c0,0,6.7,13.6,13.2,21.5c0,0,11.1,15,22.6,21 c0,0,4.9,2.4,11.7,0.4c0,0,5.3-2.6,6.6-6.8c0,0,1.1-2.9-2.9-7.6c0,0-4.5-5.5-10.9-4.5c0,0-2,0.3-3.3,2.1c0,0-2.3,2.6-7.5-1.9 L23.1,28.8c0,0-3.2-3.9-1.8-7.1c0,0,0.6-2,2.3-2.5c0,0,2.5-0.8,2.8-4.1C26.3,15.1,26.5,13.7,25.7,11.1z" />
                                                  </svg>
                                                </div>
                                              ...
                                              <a class="link-action" href="mailto:<?=option_value('contact_email')?>">
                                                ...
                                                <div class="icon-call-mail">
                                                  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g>
                                                      <path
                                                        d="M28.7,33.7c1.8,1.5,4.8,1.5,6.7,0l22.3-18c2.7-2.1,0.6-5.6-3.3-5.6H9.7c-3.9,0-6,3.4-3.3,5.6L28.7,33.7z" />
                                                      <path d="M60.5,18.8l-26.3,21c-1.3,1-3.1,1-4.4,0l-26.3-21c-0.8-0.7-2.1-0.1-2.1,0.9v26.5c0,4,3.5,7.2,7.8,7.2h45.6
                                                      c4.3,0,7.8-3.2,7.8-7.2V19.6C62.7,18.6,61.4,18.1,60.5,18.8z" />
                                                    </g>
                                                  </svg>
                                                </div>
