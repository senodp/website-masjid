		...
		<div class="col-md-12">
			<div class="col-md-12">
				<div class="form-group">
					<label for="id_listpages">Select List Artikel</label>
					<select name="id_listpages" id="id_listpages" class="form-control">
						<?=populate_select_featured_showcase_db('listpages', 'Select Artikel', $row['id_listpages'], ['name_field'=>'title', 'field_name'=>'id_listpages'])?>
					</select>
				</div>
			</div>
		</div>
