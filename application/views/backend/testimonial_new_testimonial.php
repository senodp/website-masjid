			...
			<div class="tab-content">
				<div class="tab-pane active" id="mt-eng">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="title">Nama Jamaah</label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="position">Profesi</label>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="content">Deskripsi <!-- - <i>Max.280 Characters</i> --></label>
				...
				<div class="tab-pane" id="mt-ind">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="ind_title">Nama Jamaah</label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="ind_position">Profesi</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label for="ind_content">Deskripsi <!-- - <i>Max.280 Characters</i> --></label>
	...
	<div class="row">
		<div class="col-md-12 text-center"> <hr>
			<div class="form-group" style="margin: 0;">
				<button class="btn btn-primary btn-submit btn-rounded btn-sm" tabindex="6"><span class="glyphicon glyphicon-ok"></span> Save changes</button>
				<a href="<?=$Page_url?>" tabindex="7" class="btn btn-dark btn-cancel btn-rounded btn-sm"><span class="glyphicon glyphicon-remove"></span> Cancel Changes</a>
			</div>							
		</div>
	</div>
</form>