	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="form-group">
				...
				<?=html_upload_img($row['image'],'image','galeri','800x799');?>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="image">Image 1</label>
				<?=html_upload_img($row['image_1'],'image_1','galeri','800x799');?>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="image">Image 2</label>
				<?=html_upload_img($row['image_2'],'image_2','galeri','800x799');?>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="image">Image 3</label>
				<?=html_upload_img($row['image_3'],'image_3','galeri','800x799');?>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="image">Image 4</label>
				<?=html_upload_img($row['image_4'],'image_4','galeri','800x799');?>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="image">Image 5</label>
				<?=html_upload_img($row['image_5'],'image_5','galeri','800x799');?>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="image">Image 6</label>
				<?=html_upload_img($row['image_6'],'image_6','galeri','800x799');?>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="image">Image 7</label>
				<?=html_upload_img($row['image_7'],'image_7','galeri','800x799');?>
			</div>
		</div>
